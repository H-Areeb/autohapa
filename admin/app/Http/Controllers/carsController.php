...
class carsController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       return view('vehicle_details/cars/car_features',compact('type'));
    }
    ...
    public function store(Request $request)
    {
        ...
        vehicleFeatures::create($form_data);
    ...
    public function update(Request $request)
    {
        ...
        vehicleFeatures::whereId($request->hidden_id)->update($form_data);
    ...
    public function destroy(Request $request) 
    {
        ...
        $featureDelete =   vehicleFeatures::where('id',$feature_id)->first();
