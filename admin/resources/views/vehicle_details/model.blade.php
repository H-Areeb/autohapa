         ...
         $(document).ready(function(){
                    ...
                    $.ajax({
                            ...
                            success:function(result)
                            {
                                    ...
                                    $.each(result.makes, function(i, obj2){
                                        
                                        var options = '<option value="'+obj2.id+'">'+obj2.name+'</option>';   
...
// ------------------- DELETE BUTTON  working START -----------------------------//
 ...
 $('#ok_button').click(function(){
            ...
            $.ajax({
            type: "POST",
            url : '{{ route('VehicleModel.destroy') }}',
