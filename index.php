                  ...
                  <div class="row">
                        <div class="col">
                              <div class="home-slider owl-carousel owl-theme">
                                    ...
                                    <div class="item">
                                          <img src="assets/images/slider-image.jpg" alt="Showroom of cars"
                                                class="slide-image" />
                                                ...
                                                <div class="row align-items-center slider-content-inner m-0">
                                                      ...
                                                      <div class="col-lg-7 pr-2">
                                                            <div class="text-block">
                                                                  ...
                                                                  <p>Auto dealers, vehicle owners, for sale by owner,
                                                                        all kind of auto including trucks, cars, moto
                                                                        pikes, trailers, boats, vans and so on.</p>
                                                                  <a href="" class="btn btn-blue">Find Out More <i
                                                                  ...
                                                                  <div class="form-row">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                              <select name="Distance" id="Distance"
                                                                                    class="form-control">
                                                                                    <option value="">Distance(National)*
                                                                                    </option>
                                                                              </select>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                              <select name="searchModel"
                                                                                    id="searchModel" name="searchModel"
                                                                                    class="form-control">
                                                                                    <option value="">Model(Any)*
                                                                                    </option>
                                                                              </select>
                                                                        </div>
      ...
      $.ajax({
            ...
            success: function(data) {
                  ...
                  $.each(data.MinPrice, function(i, obj) {
                        var div_data = "<option value=" + obj.MinPrice +
                              ">$" + obj.MinPrice + "</option>";
                  ...
                  $.each(data.MaxPrice, function(i, obj) {
                        var div_data = "<option value=" + obj.MaxPrice +
                              ">$" + obj.MaxPrice + "</option>";
      ...
      $.ajax({
            ...
            success: function(result) {
                  ...
                  $.each(result, function(i, obj) {
                        ...
                        var div3 = '<a href="ad-details/?ad-id=' + obj.id +
                              '&title=' + obj.title + '&price=' + obj.price +
                              '&main_img=' + obj.image + '&images=' + obj
                              .Images + '" >  <img src="assets/' + obj.image +
                              '" alt="" class="img-fluid" /></a>';
                        var div4 = ' <div class="card-body">';
                        var div5 = ' <h5 class="title">' + obj.title.substr(0,
                              20) + '...</h5>';
                        var div6 = ' <div class="price">$' + obj.price +
                              '</div>';
                        var div7 = ' <div class="tags">' + obj.milage +
                              ' miles | ' + obj.color + ' | ' + obj.variant +
                              ' |' + obj.Transmission + ' | ' + obj.FuelType +
                              '</div>';
                        var div8 = ' <a href="ad-details/?ad-id=' + obj.id +
                              '&title=' + obj.title + '&price=' + obj.price +
                              '&main_img=' + obj.image + '&images=' + obj
                              .Images +
                        ...
                        var all_div = div1 + div2 + div3 + div4 + div5 +
                              div6 + div7 + div8 + div4_end + div2_end +
                              div1_end;
...
function FillCarModels() {
      $.ajax({
            type: "GET",
            url: "ajax/ajax_get_carmodel.php?makeid=" + $("#searchMake").val() + "&type_id=" + $(
                  '#type_ids').val(),
            dataType: "json",
            success: function(data) {
