      ...
      <div class="container">
            <div class="row justify-content-center">
                  <div class="col-lg-6">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert" id="recapchaError"
                              style="display:block;">
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                          aria-hidden="true">&times;</span></button>
                                          ...
                                          <div id="section-register">
                                                ...
                                                <div class="form-group row row justify-content-end">
                                                      <label for="newPassword" class="col-sm-4 col-form-label">New
                                                            Password</label>
                                                      <div class="col-sm-8">
                                                            <input type="password" class="form-control " size="30"
                                                                  id="newPassword" name="newPassword"
                                                                  placeholder="New Password">
                                                            <span id="result"><span id="meter">Strength(<span
                                                                              id="strengthcount">0</span> of
                                                                        5)</span></span>
                                                      </div>
