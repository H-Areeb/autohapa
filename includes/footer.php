                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div>
                            ...
                            <div class="footer_copyright-text">
                                ...
                                Logo & Website Design by <a href="https://www.logoinn.com" target="_blank" style="color: #FDC731;">Logoinn</a>.
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var btn=$('.footer_to-top-link');btn.on('click',function(e){e.preventDefault();$('html, body').animate({scrollTop:0}, 1500);})
        })
