 ...
 if(searchPost === '' || searchMake === '' || searchModel === '' ){
		...
		$.ajax({
			...
			success: function(result){
				...
				// 	var arrayimg = JSON.stringify(obj.Images);
	...
	function filter_data()
    {
	   ...
	   $('#searchCarsList').html('');
        ...
        $.ajax({
            url:"../ajax/ajax_search_car_data.php",
            method:"POST",
    ...
    {	
		...
		{	
			...
			$.ajax({
            type: "GET",
            url:"../ajax/ajax_get_carmodel.php?makeid="+make_id,
            dataType: "json",
            success: function (data) {
   ...
   // GetCarsCard('+obj.id+');
		...
		function for_makes(getmake){
			...
			$.ajax({
			type:"GET",
			url:"../ajax/ajax_get_filter_data.php?getmake_id="+getmake,
			dataType:"json",
			success: function(result){
		...
		function for_models(getmodel){
			...
			$.ajax({
			type:"GET",
			url:"../ajax/ajax_get_filter_data.php?getmodel_id="+getmodel,
			dataType:"json",
			success: function(result){
