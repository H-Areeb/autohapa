	...
	else 
	{
	  ...
	  ?> 
	        ...
	        <section class="page-header mb-4">
            		<div class="container">
            			<span class="page-header__number">1</span>
                        <h1 class="page-header__title">Enter the basic details about the Bike you want to sell</h1>
            		</div>
            	</section>
            		<section class="main mb-5">
                		<div class="container">
                			...
                			<div class="row justify-content-center">
                				<div class="col-md-7">
                					<form>
                						...
                						<div class="form-group row">
                							<label for="cmbColour" class="col-sm-4 col-form-label">* Primary Colour:</label>
                							<div class="col-sm-8">
                								<select id="cmbColour" name="cmbColour" class="form-control">
                									<option value="0">Please select</option>
                								</select>
                						...
                						<div class="form-group row">
                						    <label for="" class="col-sm-4 col-form-label">* New OR Used:</label>
                    						<div class="col-sm-8">
                                                  <div class="form-switch">
            										<label for="option1" class="form-switch__label">
            											<input type="radio" id="option1"
            												class="form__control-input form-switch__input"
            												name="NewOrUsed" value="1">
            											<div class="form-switch__option">New</div>
            										</label>
            										<label for="option2" class="form-switch__label">
            											<input type="radio" id="option2"
            												class="form__control-input form-switch__input"
            												name="NewOrUsed" value="2" checked>
            											<div class="form-switch__option">Used</div>
