		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-7 card" style="border:none!important;">
				  ...
				  <h1 class="advert-heading__title text-center atc-type-insignia atc-type-insignia--medium">Thank you For subscribe</h1>
				   <h4  class="mt-3 advert-heading__title text-center">We will Contact you soon!</h4>
					...
					<div class="form-footer mb-4 mt-5">
						<div class="buttons text-center">
							<a href="javascript:void(0);" id="BtnNext" name="BtnNext" onclick="validateForm()" class="btn btn-blue">Back to Home</a>
						</div>
					</div>
			</div>
		</div>
